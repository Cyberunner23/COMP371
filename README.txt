...
In terms of feature and operation, the program is designed to follow
the requirements found in the Assignments/ProgrammingAssignment1.pdf file.
In terms of usage there should be no deviations from the requirements.
 ...
 * `cmake ..`
 * `cmake --build .`
 **Note:** The first time you compile it will take rather long.
 ...
 files.
 **Other note:** If you're using GCC-7.3, don't. GLM currently has a bug
